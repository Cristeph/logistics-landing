      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          <div className="flex items-center">
            <p className="font-bold text-xl mr-2">Get Payment by ID</p>
          </div>
        </div>
      </div>
            ...
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center">
                ...
                <p className="font-semibold">
                  Order ID: #{order.order.trackingNumber}
                </p>
              </div>
            ...
            <div className="mb-2">
              <div className="flex items-center mb-1">
                ...
                <p className="text-sm text-gray-700">
                  Pickup Location:{" "}
                  {`${order.order.pickupAddress.street}, ${order.order.pickupAddress.city}, ${order.order.pickupAddress.country}`}
                </p>
              </div>
              <div className="flex items-center">
                <FaMapMarkerAlt className="text-blue-500 mr-2" />
                <p className="text-sm text-gray-700">
                  Drop Location:{" "}
                  {`${order.order.dropoffAddress.street}, ${order.order.dropoffAddress.city}, ${order.order.dropoffAddress.country}`}
                </p>
              </div>
            </div>
